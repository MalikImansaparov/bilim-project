          ...
          {i18n.language === 'ky' && (
            <div className="wrapper">
              ...
              <div className="mb-8">
                ...
                <p className="mb-6 font-semibold text-[18px] lg:text-[18px] 3md:text-[16px] sm:mt-2">
                  {response.title_ky}
                </p>
                ...
                <p className="text-grey mt-8 flex">
                  ...
                  <span className="text-black ">
                    &nbsp;{response.event_date.split('-').reverse().join('-')}
                  </span>
                </p>
