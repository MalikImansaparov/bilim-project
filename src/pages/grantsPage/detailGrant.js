            ...
            <div className="wrapper">
              ...
              <div className="mb-8 relative">
                ...
                <div className="flex flex-wrap 2md:text-[12px] md:max-w-[500px] justify-between mb-4">
                  ...
                  {response.place_ky && (
                    <div className="flex 1xs:mt-1 mr-1 w-[220px] 1md:w-[170px] items-center">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                      ...
                      {i18n.language === 'ky' && (
                        <p className="ml-1 flex items-center">
                          <span className="font-bold mr-0.5 items-center">
                            {t('where')}{' '}
                          </span>{' '}
                          {response.place_ky}
                        </p>
            ...
            <div className="wrapper">
              ...
              <div className="mb-8">
                ...
                <div className="flex flex-wrap 2md:text-[12px] md:max-w-[500px] justify-between mb-4">
                  ...
                  {response.place_ky && (
                    <div className="flex items-center mr-1 w-[220px] 1md:w-[170px]">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                        viewBox="0 0 24 24"
                      ...
                      {i18n.language === 'ky' && (
                        <p className="ml-1 flex items-center pt-2">
                          <span className="font-bold mr-0.5">
                            {t('where')}{' '}
                          </span>{' '}
                          {response.place_ky}
                      ...
                      {i18n.language === 'ru' && (
                        <p className="ml-1 flex items-center">
                          <span className="font-bold mr-0.5d">
                            {t('where')}{' '}
                          </span>{' '}
                          {response.place_ru}
                        </p>
