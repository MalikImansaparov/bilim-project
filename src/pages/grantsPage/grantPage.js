        ...
        >
            ...
            <div className="flex">
                ...
                <div className="flex 1xs:mt-1">
                    ...
                    <p className="pl-1 flex items-center"><span className="font-bold mr-0.5">{t('deadline')}</span> {item.deadline.split('-').reverse().join('.')}}</p>
                </div>
                            )}
                        {item.period && (
                    <div className="flex 1xs:mt-1">
                        ...
                        <p className="pl-1 flex items-center"><span className="font-bold mr-0.5">{t('when')}</span> {item.period.split('-').reverse().join('.')}}</p>
                    </div>
                            )}
                </div>
                    ...
                    <div className="flex flex-wrap 2md:text-[12px] max-w-[500px] justify-between w-full mb-4">
                        ...
                        <div className="flex 1xs:mt-1">
                            ...
                            <p className="pl-1 flex items-center"><span className="font-bold mr-0.5">{t('grant')} </span> {item.grant_amount}</p>
                        </div>
                            )}
                        {item.place_ky && (
                        <div className="flex 1xs:mt-1">
                            ...
                            { i18n.language === "ky" && <p className="ml-1 self-start flex items-center"><span className="font-bold mr-0.5">{t('where')} </span> {item.place_ky}</p>}
                            { i18n.language === "ru" && <p className="ml-1 flex items-center"><span className="font-bol mr-0.5d">{t('where')} </span> {item.place_ru}</p>}
                            { i18n.language === "en" && <p className="ml-1 self-start flex items-center"><span className="font-bold mr-0.5">{t('where')} </span> {item.place_en}</p>}
                        </div>
                            )}
                    </div>
                </div>
            ...
            <Link to={`${item.id}`} className="py-[10px] px-[15px] flex items-center bg-blueLight">
