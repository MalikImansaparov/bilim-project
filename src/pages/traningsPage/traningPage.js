...
export const TrainingPage = () => {
  const { isLoading} = useFetch(api + '/training/');
        ...
        {response &&
            response.map((item) => (
                ...
                >
                      ...
                      <div className="flex flex-wrap mt-4 mb-1 max-w-[500px] justify-between w-full 2md:text-[12px]">
                        {item.date && (
                            <div className="flex 1xs:mt-1">
                              ...
                              <p className="pl-1 flex items-center"><span className="font-bold mr-0.5">{t('when')}</span> {item.date.split('-').reverse().join('.')}}</p>
                            </div>
                        )}
                        {item.place_ky && (
                            <div className="flex 1xs:mt-1">
                  ...
                  <div className="flex justify-end max-w-[1086px] m-auto mt-2 1xs:mt-1">
